...
@push('crud_fields_styles')
    @basset('https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta3/dist/css/bootstrap-select.min.css')
    <style>
...
@push('crud_fields_scripts')
    @basset('https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta3/dist/js/bootstrap-select.min.js')
    <script>
        jQuery(document).ready(function($) {
            var $typesSelect = $('select[name="types[]"]');
            if ($typesSelect.length) {
                $typesSelect.addClass('selectpicker').selectpicker({
                    container: 'body',
                    liveSearch: true,
                    style: '',
                    styleBase: 'form-control',
                    size: 7,
                    noneSelectedText: '-- Select Vendor Types --',
                    selectedTextFormat: 'count > 3',
                    tickIcon: 'la la-check text-primary',
                    iconBase: ''
                });
            }
        });
